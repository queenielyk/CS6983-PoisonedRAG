...
def parse_args():
    ...
    parser.add_argument('--repeat_times', type=int, default=5, help='repeat several times to compute average')
    parser.add_argument('--M', type=int, default=5, help='one of our parameters, the number of target queries')
                ...
                iter_results.append(
                    {
                        ...
                        "benign_size": len(qrels[incorrect_answers[i]['id']]),
                        "question": question,
